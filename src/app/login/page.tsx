...
export default function LoginPage() {
  ...
  const { login, loginWithGoogle, configured } = useStore();
  ...
  return (
    <AuthFrame title="Bienvenido a Orbix" subtitle="Inicia sesión para acceder a tu empresa" orb={orb}>
      <div className="space-y-4">
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          >
            {submitting ? "Iniciando sesión…" : "Entrar a mi cuenta"}
          </Button>
